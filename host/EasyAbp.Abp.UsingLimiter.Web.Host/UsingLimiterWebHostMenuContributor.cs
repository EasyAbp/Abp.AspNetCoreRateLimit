...
{
    public class UsingLimiterWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public UsingLimiterWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<UsingLimiterResource>>();
